...
/**
 * Componente principal da página inicial da academia.
 * Exibe as informações sobre os serviços, benefícios e planos da academia.
 * 
 * @returns {JSX.Element} A interface visual da página inicial da academia.
 */
function HomePage() {
  return (
